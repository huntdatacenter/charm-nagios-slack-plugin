...
SHELL := /bin/bash
# Charm variables
CHARM_NAME := nagios-slack-plugin
CHARM_STORE_URL := cs:~huntdatacenter/nagios-slack-plugin
CHARM_HOMEPAGE := https://github.com/huntdatacenter/charm-nagios-slack-plugin/
CHARM_BUGS_URL := https://github.com/huntdatacenter/charm-nagios-slack-plugin/issues
